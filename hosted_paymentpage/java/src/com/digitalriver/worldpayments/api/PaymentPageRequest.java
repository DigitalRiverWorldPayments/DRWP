...
public class PaymentPageRequest extends AbstractPaymentPageRequest {
    ...
    /**
     * When building a customized template this can be used for ${param.*} in
     * template. Name-value pair, separated by "#". E.g.
    ...
    /**
     * ISO-3166, e.g. US. Used together with language to form the locale being
    ...
    /**
     * When consumer has completed the payment page session this URL will be
    ...
    /**
     * Maximum time in seconds for the PaymentPageRequest to be valid. Set this
    ...
    /**
     * Indicates that a token should be stored. '0' = Store not used, '1' =
